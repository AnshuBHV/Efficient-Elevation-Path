...
/////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
//  Written By : Anshuman Bhamidipati            Environment : ubuntu:bionic               //
//  Date ......: 2024/02/29                      Compiler ...: clang++                   //
/////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
// clang-format on
/////////////////////////////////////////////////////////////////////////////////////////////
...
TEST_CASE("Example Elevation Data Test", "[ed-forward-2-3]") {
  ...
  REQUIRE(max == ed.MaxEle());
  REQUIRE(min == ed.MinEle());
}
...
TEST_CASE("Example Grayscale Data Test", "[gi-forward-2-3]") {
  ...
  REQUIRE(kTestFileWidth == gi.Width());
  REQUIRE(kTestFileHeight == gi.Height());
}
...
TEST_CASE("PPM Example Test: Grayscale image from map-input-w51-h55.dat",
          "[ppm_ex_grayscale_map-input-w51-h55.dat]") {
  const std::string kStudentOutput =
      "./student_out/ex_grayscale_map-input-w51-h55.dat.ppm";
...
TEST_CASE("PPM Example Test: Grayscale image from map-input-w480-h480.dat",
          "[ppm_ex_grayscale_map-input-w480-h480.dat]") {
  const std::string kStudentOutput =
      "./student_out/ex_grayscale_map-input-w480-h480.dat.ppm";
  const std::string kTestFile =
      "./example-data/ex_input_data/map-input-w480-h480.dat";
  const std::string kGroundTruth =
      "./example-data/ex_output_grayscale/map-input-480-480.ppm";
...
TEST_CASE("Example Test: Path image from prompt_w51_h55.ppm",
...
TEST_CASE("Example Test: Path image from prompt_w480_h480.ppm",
